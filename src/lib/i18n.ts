...
export const COPY = {
  tr: {
    ...
    launcher: {
      ...
      savedServer: "Kayıtlı sunucu",
      savedServerPlaceholder: "Sunucu seç",
      noSavedServers: "Kayıtlı sunucu yok",
      saveSourceServer: "Kaynak sunucuyu sık kullanılanlara kaydet",
      saveTargetServer: "Hedef sunucuyu sık kullanılanlara kaydet",
      serverName: "Sunucu adı",
      serverNamePlaceholder: "Örn: Production VPS",
    ...
    settings: {
      ...
      serversTitle: "Kayıtlı sunucular",
      serversDescription: "Sık kullandığınız SSH sunucularını düzenleyin.",
      serversTag: "Host kayıtları",
    ...
    savedServers: {
      ...
      description: "Hizmetlerde tekrar kullanacağınız sunucu adlarını ve host/IP bilgilerini yönetin.",
      ...
      add: "Ekle",
      adding: "Ekleniyor",
      savedTitle: "Sunucu listesi",
      save: "Kaydet",
      saving: "Kaydediliyor",
      delete: "Sil",
      loading: "Yükleniyor...",
      emptyTitle: "Kayıtlı sunucu yok",
      emptyDescription: "Formlardan kaydettiğiniz veya buradan eklediğiniz sunucular burada görünür.",
      loadError: "Sunucular yüklenemedi.",
      addError: "Sunucu eklenemedi.",
      updateError: "Sunucu güncellenemedi.",
      deleteError: "Sunucu silinemedi.",
      deleteConfirm: "Bu kayıtlı sunucuyu silmek istediğinize emin misiniz?"
    },
    billing: {
      back: "Geri Dön",
      backToSettings: "Ayarlara Dön",
    ...
    checkout: {
      ...
      couponPlaceholder: "Kupon kodunu gir",
      haveCoupon: "İndirim kodun var mı?",
      ...
      secureNote: "Ödeme PayTR güvencesiyle alınır. Planın ödeme onaylanır onaylanmaz aktifleşir.",
  ...
  en: {
    ...
    launcher: {
      ...
      savedServerPlaceholder: "Choose server",
      noSavedServers: "No saved servers",
      saveSourceServer: "Save source server for reuse",
      saveTargetServer: "Save target server for reuse",
      serverName: "Server name",
      serverNamePlaceholder: "E.g. Production VPS",
    ...
    settings: {
      ...
      billingTag: "Billing",
      serversTitle: "Saved servers",
      serversDescription: "Edit SSH servers you reuse often.",
      serversTag: "Host records",
    ...
    savedServers: {
      backToSettings: "Back to settings",
      title: "Saved servers",
      description: "Manage server names and host/IP values you reuse in operations.",
      addTitle: "Add server",
      ...
      add: "Add",
      adding: "Adding",
      savedTitle: "Server list",
      save: "Save",
      saving: "Saving",
      delete: "Delete",
      loading: "Loading...",
      emptyTitle: "No saved servers",
      emptyDescription: "Servers saved from forms or added here will appear in this list.",
      ...
      deleteConfirm: "Are you sure you want to delete this saved server?"
    },
    billing: {
      back: "Go Back",
      backToSettings: "Back to Settings",
    ...
    checkout: {
      ...
      billedOnce: "One-time payment",
      preparing: "Preparing payment page...",
      proceed: "Continue to secure payment",
      secureNote: "Payment is secured by PayTR. Your plan activates as soon as the payment is confirmed.",
